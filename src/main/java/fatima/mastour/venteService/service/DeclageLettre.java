...
public class DeclageLettre {
    ...
    public String codeBarre(String nom,String prenom,int j){
        ...
        code_barre+=calendar.get(Calendar.MILLISECOND)+calendar.get(Calendar.MINUTE)+j+calendar.get(Calendar.HOUR_OF_DAY)+calendar.get(Calendar.SECOND)+calendar.get(Calendar.DAY_OF_WEEK)+calendar.get(Calendar.DAY_OF_MONTH);
