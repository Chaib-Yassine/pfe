...
public class TicketServiceApplication {
    ...
    CommandLineRunner start(TicketRepository ticketRepository, RepositoryRestConfiguration restConfiguration){
        ...
        return args ->{
             ticketRepository.save(new Ticket(null, 1, 012, true, 12));
             ticketRepository.save(new Ticket(null, 1234, 0123, true,13));
             ticketRepository.save(new Ticket(null, 12345,01234, true,14));
             ticketRepository.save(new Ticket(null, 123456,012345, false,15));
